...
It does this by modifying HTTP traffic which in turn reduces 
web page latency, and improves web security. HTTP, while powerful in its day,
cannot keep up with the demands of today's digital world,
which is the reason SPDY was introduced to help meet those demands.
